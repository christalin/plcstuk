...
ActiveRecord::Schema.define(version: 20151212164328) do
  ...
  create_table "chklistdata", force: :cascade do |t|
    t.string   "evntid"
    t.string   "chklstid"
    t.string   "assignedto"
    t.string   "completed"
  ...
  create_table "hnccontacts", force: :cascade do |t|
    t.string   "department"
    t.string   "name"
    t.string   "phone"
    t.string   "email"
  ...
  create_table "pastads", force: :cascade do |t|
    t.string   "name"
    t.string   "date"
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
  ...
  create_table "plcchecklists", force: :cascade do |t|
    t.string   "name"
    t.string   "attachment"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
